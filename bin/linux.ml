      ...
      ( "mounts",
        `List
          ...
          @ [
              ...
              (* Not noexec, unlike the mounts around it: a build or test suite
                 may stage a binary in /tmp and run it. *)
              Mount.make "/tmp" ~ty:"tmpfs" ~src:"tmpfs" ~options:[ "nosuid"; "noatime"; "nodev"; "mode=1777" ];
