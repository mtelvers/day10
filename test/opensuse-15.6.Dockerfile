...
FROM --platform=linux/amd64 opensuse/leap:15.6 AS day10-install-builder
RUN zypper refresh && zypper install -y gcc gcc-c++ make patch unzip bzip2 tar git curl diffutils findutils gzip
